...
"""
  ...
  Example usage:
    ...
    saver = tf.train_old.import_meta_graph('infer.meta')
...
if __name__ == '__main__':
  ...
  parser.add_argument('mode', type=str, choices=['train_old', 'preview', 'incept', 'infer'])
  ...
  wavegan_args = parser.add_argument_group('ProducerGAN')
